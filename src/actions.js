...
export function fetchRandomItunes() {
  return function(dispatch){
    ...
    console.log('actions.fetchRandomItuens')
    ...
    const randomArtistIds = `${artists[Math.floor(Math.random() * 10)].amgArtistId},${artists[Math.floor(Math.random() * 10)].amgArtistId},${artists[Math.floor(Math.random() * 10)].amgArtistId}`
